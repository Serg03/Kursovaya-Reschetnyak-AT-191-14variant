namespace Курсовая
{
	partial class Form4
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridView1.Location = new System.Drawing.Point(146, 314);
			this.dataGridView1.Name = "dataGridView1";
			this.dataGridView1.Size = new System.Drawing.Size(696, 103);
			this.dataGridView1.TabIndex = 0;
			// 
			// textBox5
			// 
			this.textBox5.Location = new System.Drawing.Point(17, 131);
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(658, 102);
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(456, 252);
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(579, 252);
			...
			// textBox6
			// 
			this.textBox6.Location = new System.Drawing.Point(742, 252);
			...
			this.label7.Location = new System.Drawing.Point(575, 207);
			this.label7.Name = "label7";
			this.label7.Size = new System.Drawing.Size(125, 21);
			this.label7.TabIndex = 34;
			this.label7.Text = "Имя Отчество";
			// 
			// label3
			// 
			...
			this.label6.Location = new System.Drawing.Point(654, 78);
			...
			this.button1.Location = new System.Drawing.Point(713, 461);
			...
			this.label8.Text = "Введите порядковый номер человека,";
			// 
			// label9
			// 
			...
			this.label9.Text = "данные которого желаете изменить,";
			// 
			// label10
			// 
			...
			this.label10.Location = new System.Drawing.Point(327, 151);
			this.label10.Name = "label10";
			this.label10.Size = new System.Drawing.Size(405, 19);
			this.label10.TabIndex = 39;
			this.label10.Text = "(пустое поле означает, что эти данные не будут изменены)";
			// 
			// label11
			// 
			...
			this.label11.Text = "Прошлые данные";
			// 
			// label12
			// 
			...
			this.label12.Text = "Новые данные";
			// 
			// button2
			// 
